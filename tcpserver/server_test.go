...
//Test PreHandle
func (this *PingRouter) PreHandle(request IRequest) {
...
//Test Handle
func (this *PingRouter) Handle(request IRequest) {
...
//Test PostHandle
func (this *PingRouter) PostHandle(request IRequest) {
...
func (this *HelloRouter) Handle(request IRequest) {
...
func DoConnectionBegin(conn IConnection) {
...
//连接断开的时候执行
func DoConnectionLost(conn IConnection) {
...
// 	routers := map[uint32]IRouter{1: &PingRouter{}, 2: &HelloRouter{}}
